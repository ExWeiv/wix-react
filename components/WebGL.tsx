...
function Switch({ x, set }) {
  const { nodes, materials } = useGLTF("https://static.wixstatic.com/3d/510eca_398fc69b59ae422495a7c024d5d21246.glb");
  const texture = useTexture("https://static.wixstatic.com/media/510eca_dda9c519b95047cca8210536c6578c48~mv2.jpg");
  // Hover state
...
export default function App() {
  ...
  return (
    <animated.div className="container" style={{ backgroundColor: x.to([0, 1], ["#c9ffed", "#ff2558"]), color: x.to([0, 1], ["#7fffd4", "#c70f46"]) }}>
      <h1 className="open" children="<wix+react>" />
      <h1 className="close" children="</wix+react>" />
